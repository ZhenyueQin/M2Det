...
while True:
    ...
    #                                                        , labels[int(oo)], ooo) for o, oo, ooo in
    #                  zip(boxes, cls_inds, scores)]))
    for o, oo, ooo in zip(boxes, cls_inds, scores):
        if fname not in rtn_dict:
            rtn_dict[fname] = [((o[0], o[1], o[2], o[3]), labels[int(oo)], ooo)]
        else:
            rtn_dict[fname].append(((o[0], o[1], o[2], o[3]), labels[int(oo)], ooo))
